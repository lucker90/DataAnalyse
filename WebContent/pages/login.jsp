				...
				if(userVerify && pwdVerify){
					$.ajax({
						...
						success:function(res){
							...
							//alert(res.back);
							if(res.back=='success'){
								window.location.href = "http://localhost:8080/lucker/pages/systemmanager/" + res.url+".html";
							}else{
								alert(res.msg);
							}
						}
...
<div class="bottom_bg">
    <div class="bottom">版权所有:王翠娟 地址:北京市海淀区学院路37好 邮编:100083 Email:wangcjuan@126.com</div>
</div>
</body>
</html>